...
declare global {
  ...
  interface ViteEnv {
    ...
    VITE_GLOB_U_SERVICE_API_BASE: string;
    VITE_GLOB_U_SERVICE_AUTH_QRCODE_URL: string;
    VITE_GLOB_U_SERVICE_WEBSOCKET_URL: string;
  }
  ...
  interface PlatformConfigs {
    ...
    ShowFloatSidebarCollapseTrigger?: boolean;
  }
  ...
  type UnwrapperReadonly<T> = { -readonly [K in keyof T]: T[K] };
}
